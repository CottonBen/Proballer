...
const STRINGS = {
    ...
    'email.release.body': 'Varauksesi {code} ({date} {hours}, valmentaja {coach}) peruuntui automaattisesti, koska maksua ei suoritettu loppuun. Rahaa ei veloitettu, ja aika vapautui muiden varattavaksi.',
    'email.release.note': 'Jos haluat treenin edelleen, varaa uusi aika — maksu tapahtuu heti varauksen yhteydessä.',
  ...
  en: {
    ...
    'email.release.body': 'Your booking {code} ({date} {hours} with {coach}) was cancelled automatically because the payment was not completed. Nothing was charged, and the slot has been released for others to book.',
    'email.release.note': 'If you still want the session, simply book a new time — payment happens right at booking.',
