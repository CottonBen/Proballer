...
const I18N_DICT = {
  ...
  'landing.how.step1.body': {
    fi: 'Valitse valmentaja ja jokin hänen kalenteriinsa avaamistaan ajoista. Treenejä on joka päivä klo 8.00–22.00.',
    en: 'Choose a coach and one of the times they have opened in their calendar. Sessions run 8:00–22:00, every day.' },
  ...
  "booking.step.time.subtitle": { fi: "Kaikki ajat ovat tunnin treenejä Suomen aikaa (klo 8.00–22.00). Vain valmentajan avaamat ajat näytetään.", en: "All times are one-hour sessions, Finnish time (8:00–22:00). Only times the coach has opened are shown." },
  ...
  "profile.cta.hint": { fi: "Valitse seuraavassa vaiheessa jokin vapaista ajoista, jotka {firstName} on avannut — treenejä on joka päivä klo 8.00–22.00.", en: "Pick one of {firstName}'s free times in the next step — sessions run 8:00–22:00, every day." },
  ...
  "coachdash.cal.help1": { fi: "Klikkaa tunteja merkitäksesi itsesi vapaaksi (klo 8.00–22.00). Mikään tunti", en: "Click hours to mark yourself free (8:00–22:00). Every hour is treated as" },
  ...
  "admin.invoicestatus.atsession": { fi: "maksu paikan päällä", en: "pay at the session" },
  "admin.nb.open": { fi: "+ Luo varaus", en: "+ Create a booking" },
  "admin.nb.title": { fi: "Luo varaus asiakkaalle", en: "Create a booking for a customer" },
  "admin.nb.step": { fi: "Vaihe {n}/4", en: "Step {n}/4" },
  "admin.nb.existing": { fi: "Nykyinen asiakas", en: "Existing customer" },
  "admin.nb.new": { fi: "Uusi asiakas", en: "New customer" },
  "admin.nb.search.ph": { fi: "Hae nimellä tai sähköpostilla…", en: "Search by name or email…" },
  "admin.nb.noresults": { fi: "Ei osumia.", en: "No matches." },
  "admin.nb.newnote": { fi: "Asiakkaalle luodaan tili ja kaikki viestit (vahvistukset, maksupyyntö, muistutukset) lähtevät tähän sähköpostiin.", en: "An account is created for the customer and every message (confirmations, payment request, reminders) goes to this email." },
  "admin.nb.name.ph": { fi: "Nimi", en: "Name" },
  "admin.nb.email.ph": { fi: "Sähköposti", en: "Email" },
  "admin.nb.phone.ph": { fi: "Puhelin (valinnainen)", en: "Phone (optional)" },
  "admin.nb.area": { fi: "Alue (valinnainen)", en: "Area (optional)" },
  "admin.nb.area.none": { fi: "Ei valittu", en: "Not set" },
  "admin.nb.lang": { fi: "Viestien kieli", en: "Language for messages" },
  "admin.nb.kind": { fi: "Millainen treeni?", en: "What kind of session?" },
  "admin.nb.kind.single": { fi: "Yksityistreeni (1-on-1)", en: "Private session (1-on-1)" },
  "admin.nb.kind.group": { fi: "Ryhmätreeni", en: "Group session" },
  "admin.nb.coach": { fi: "Valmentaja", en: "Coach" },
  "admin.nb.coach.pick": { fi: "Valitse valmentaja", en: "Pick a coach" },
  "admin.nb.city": { fi: "Kaupunki", en: "City" },
  "admin.nb.slot": { fi: "Vapaa aika", en: "Open time" },
  "admin.nb.noslots": { fi: "Ei vapaita aikoja tälle valmentajalle.", en: "No open times for this coach." },
  "admin.nb.notes": { fi: "Toiveet valmentajalle (valinnainen)", en: "Wishes for the coach (optional)" },
  "admin.nb.nogroups": { fi: "Ei avoimia ryhmätreenejä, joissa on tilaa.", en: "No open group sessions with room." },
  "admin.nb.group.spots": { fi: "{taken}/{capacity} pelaajaa", en: "{taken}/{capacity} players" },
  "admin.nb.payment": { fi: "Miten maksu hoidetaan?", en: "How is the payment handled?" },
  "admin.nb.pay.link": { fi: "Lähetä maksupyyntö sähköpostitse", en: "Send a payment request by email" },
  "admin.nb.pay.link.sub": { fi: "Asiakas saa maksulinkin sähköpostiinsa — aikaa {hours} tuntia, kuitenkin ennen treenin alkua.", en: "The customer gets a payment link by email — {hours} hours to pay, at the latest before the session." },
  "admin.nb.pay.paid": { fi: "Maksu on jo suoritettu", en: "Payment already completed" },
  "admin.nb.pay.paid.sub": { fi: "Merkitään heti maksetuksi ja asiakkaalle lähetetään kuitti.", en: "Marked paid right away and the customer gets a receipt." },
  "admin.nb.pay.at_session": { fi: "Maksu paikan päällä", en: "Payment at the session" },
  "admin.nb.pay.at_session.sub": { fi: "Varaus vahvistetaan heti — merkitse maksu saaduksi jälkikäteen Varaukset-taulukosta.", en: "The booking is confirmed right away — mark the money received afterwards from the bookings table." },
  "admin.nb.confirm": { fi: "Vahvista varaus", en: "Confirm the booking" },
  "admin.nb.sum.customer": { fi: "Asiakas", en: "Customer" },
  "admin.nb.sum.newaccount": { fi: "uusi tili luodaan", en: "a new account will be created" },
  "admin.nb.sum.session": { fi: "Treeni", en: "Session" },
  "admin.nb.sum.price": { fi: "Hinta", en: "Price" },
  "admin.nb.sum.payment": { fi: "Maksu", en: "Payment" },
  "admin.nb.create": { fi: "Luo varaus", en: "Create the booking" },
  "admin.nb.back": { fi: "Takaisin", en: "Back" },
  "admin.nb.next": { fi: "Seuraava", en: "Next" },
  "admin.nb.done.link": { fi: "Varaus luotu — maksupyyntö lähetetty osoitteeseen {email}.", en: "Booking created — payment request sent to {email}." },
  "admin.nb.done.paid": { fi: "Varaus luotu ja merkitty maksetuksi — kuitti lähti asiakkaalle.", en: "Booking created and marked paid — the receipt went to the customer." },
  "admin.nb.done.at_session": { fi: "Varaus luotu — maksu peritään paikan päällä.", en: "Booking created — the payment is collected at the session." },
  "admin.nb.err.customer": { fi: "Valitse asiakas tai luo uusi.", en: "Pick a customer or create a new one." },
  "admin.nb.err.slot": { fi: "Valitse valmentaja, kaupunki ja aika.", en: "Pick a coach, a city and a time." },
  "admin.nb.err.group": { fi: "Valitse ryhmätreeni.", en: "Pick a group session." },
  "admin.groups.markpaid": { fi: "Merkitse maksetuksi", en: "Mark paid" },
  ...
  "fm.back": { fi: "← Komentokeskus", en: "← Command center" },
  "fm.disclaimer": { fi: "Kaikki mallinnetut luvut ovat yksinkertaistettuja arvioita. Vero on yksinkertaistettu mallinnusoletus eikä korvaa suomalaista vero- tai kirjanpitoneuvontaa. Mallin muuttaminen ei koskaan muuta oikeita varauksia, maksuja tai asiakastietoja.", en: "All modelled figures are simplified estimates. Tax is a simplified modelling assumption and is not a substitute for Finnish tax or accounting advice. Changing the model never modifies real bookings, payments or customer data." },
  "fm.badge.actual": { fi: "TOTEUMA", en: "ACTUAL" },
  "fm.badge.model": { fi: "MALLI", en: "MODELLED" },
  "fm.badge.scenario": { fi: "TAVOITESKENAARIO", en: "TARGET SCENARIO" },
  "fm.actual.heading": { fi: "Todellinen liiketoiminta", en: "Actual business data" },
  "fm.actual.sub": { fi: "Vain luku — samat luvut kuin Komentokeskuksen talousraportissa. Malli ei koskaan muuta näitä.", en: "Read-only — the same figures as the command center's finance report. The model never modifies these." },
  "fm.actual.load": { fi: "Lataa toteuma malliin", en: "Load actuals into the model" },
  "fm.actual.loaded": { fi: "Toteuma ladattu mallin lähtöarvoiksi.", en: "Actuals loaded as the model's starting point." },
  "fm.actual.revmonth": { fi: "Liikevaihto tässä kuussa", en: "Revenue this month" },
  "fm.actual.rev30": { fi: "Liikevaihto 30 pv", en: "Revenue, 30 days" },
  "fm.actual.customers": { fi: "Aktiiviset asiakkaat 30 pv", en: "Active customers, 30 days" },
  "fm.actual.customers.sub": { fi: "tilejä yhteensä {total}", en: "{total} accounts in total" },
  "fm.actual.sessions": { fi: "Pidetyt treenit 30 pv", en: "Sessions held, 30 days" },
  "fm.actual.sessions.sub": { fi: "{solo} yksityistä · {group} ryhmää", en: "{solo} private · {group} group" },
  "fm.actual.avgprice": { fi: "Toteutunut keskihinta", en: "Actual average price" },
  "fm.actual.coachcost": { fi: "Valmentajakulu / treeni", en: "Coach cost / session" },
  "fm.actual.coachcost.sub": { fi: "keskiarvo 90 pv", en: "90-day average" },
  "fm.actual.payouts": { fi: "Valmentajapalkkiot 30 pv", en: "Coach payouts, 30 days" },
  "fm.actual.profit": { fi: "Tulos ennen kiinteitä kuluja", en: "Profit before fixed costs" },
  "fm.actual.profit.sub": { fi: "30 pv: liikevaihto − palkkiot", en: "30 days: revenue − payouts" },
  "fm.model.heading": { fi: "Skenaariomalli", en: "Financial scenario model" },
  "fm.model.sub": { fi: "Liu'uta oletuksia — kaikki luvut, katteet, nollapiste ja kaaviot päivittyvät heti.", en: "Move the assumptions — every figure, margin, break-even and chart updates instantly." },
  "fm.defaults.save": { fi: "Tallenna oletusarvoiksi", en: "Save as defaults" },
  "fm.defaults.saved": { fi: "Oletusarvot tallennettu.", en: "Defaults saved." },
  "fm.inputs.heading": { fi: "Oletukset (mallinnettuja)", en: "Assumptions (modelled)" },
  "fm.in.price": { fi: "Hinta / treeni (€)", en: "Price / session (€)" },
  "fm.in.customers": { fi: "Aktiiviset asiakkaat", en: "Active customers" },
  "fm.in.sessionsPerCustomer": { fi: "Treenejä / asiakas / kk", en: "Sessions / customer / month" },
  "fm.in.coachCost": { fi: "Valmentajakulu / treeni (€)", en: "Coach cost / session (€)" },
  "fm.in.extraFixed": { fi: "Muut kiinteät kulut / kk (€)", en: "Other fixed costs / month (€)" },
  "fm.in.taxRate": { fi: "Vero-oletus (%)", en: "Modelled tax rate (%)" },
  "fm.in.arpc": { fi: "Keskilaskutus / asiakas (€, 0 = ei käytössä)", en: "Avg revenue / customer (€, 0 = off)" },
  "fm.in.coachMode": { fi: "Valmentajakulun peruste", en: "Coach cost basis" },
  "fm.in.coachMode.per": { fi: "€ / treeni", en: "€ / session" },
  "fm.in.coachMode.pct": { fi: "% liikevaihdosta", en: "% of revenue" },
  "fm.in.taxBasis": { fi: "Veron peruste", en: "Tax basis" },
  "fm.in.taxBasis.profit": { fi: "Tulos (oletus)", en: "Profit (default)" },
  "fm.in.taxBasis.revenue": { fi: "Liikevaihto (valinnainen)", en: "Revenue (opt-in)" },
  "fm.tax.disclaimer": { fi: "Vero on yksinkertaistettu mallinnusoletus — ei ALV:tä eikä virallista verolaskentaa. Tappiosta ei mallinneta negatiivista veroa.", en: "Tax is a simplified modelling assumption — no VAT and no official tax computation. Losses carry no negative tax." },
  "fm.tip.price": { fi: "Mitä yksi treeni maksaa asiakkaalle.", en: "What one session costs the customer." },
  "fm.tip.customers": { fi: "Kuinka monta maksavaa asiakasta kuukaudessa.", en: "How many paying customers per month." },
  "fm.tip.spc": { fi: "Montako treeniä keskivertoasiakas ostaa kuukaudessa.", en: "How many sessions the average customer buys per month." },
  "fm.tip.coach": { fi: "Mitä valmentajalle maksetaan yhdestä treenistä.", en: "What the coach is paid for one session." },
  "fm.tip.fixed": { fi: "Pikasäätö kuluriveille — lisätään kulutaulukon kiinteisiin kuluihin.", en: "Quick adjustment on top of the itemized fixed costs below." },
  "fm.tip.tax": { fi: "Yksinkertaistettu veroprosentti mallinnettuun tulokseen.", en: "Simplified tax rate on the modelled profit." },
  "fm.tip.arpc": { fi: "Valinnainen: jos > 0, liikevaihto lasketaan asiakasta kohden tämän mukaan hinnan sijasta.", en: "Optional: when > 0, revenue is driven per customer by this instead of price × sessions." },
  "fm.tip.taxbasis": { fi: "Oletus: vero lasketaan tuloksesta. Liikevaihtoperuste on erillinen valinta.", en: "Default: tax is computed on profit. The revenue basis is an explicit opt-in." },
  "fm.kpi.revenue": { fi: "Liikevaihto / kk", en: "Monthly revenue" },
  "fm.kpi.revenue.sub": { fi: "{annual} / v · {sessions} treeniä", en: "{annual} / yr · {sessions} sessions" },
  "fm.kpi.costs": { fi: "Kulut / kk", en: "Monthly costs" },
  "fm.kpi.costs.sub": { fi: "muuttuvat {vc} · kiinteät {fc}", en: "variable {vc} · fixed {fc}" },
  "fm.kpi.gross": { fi: "Bruttokate", en: "Gross profit" },
  "fm.kpi.grossmargin": { fi: "Bruttokate-%", en: "Gross margin" },
  "fm.kpi.net": { fi: "Nettotulos / kk", en: "Net profit / month" },
  "fm.kpi.net.sub": { fi: "{annual} / v", en: "{annual} / yr" },
  "fm.kpi.netmargin": { fi: "Nettomarginaali", en: "Net margin" },
  "fm.kpi.berevenue": { fi: "Nollapisteen liikevaihto", en: "Break-even revenue" },
  "fm.kpi.becustomers": { fi: "Asiakkaita nollapisteeseen", en: "Customers to break even" },
  "fm.tip.revenue": { fi: "Treenit × hinta (tai asiakkaat × keskilaskutus).", en: "Sessions × price (or customers × avg revenue per customer)." },
  "fm.tip.variable": { fi: "Suorat kulut, jotka kasvavat myynnin mukana: valmentajapalkkiot, per-treeni-kulut ja %-liikevaihdosta-kulut (esim. maksunvälitys).", en: "Direct costs that grow with sales: coach fees, per-session costs and %-of-revenue costs (e.g. payment processing)." },
  "fm.tip.gross": { fi: "Liikevaihto miinus suorat/muuttuvat kulut.", en: "Revenue minus direct/variable costs." },
  "fm.tip.grossmargin": { fi: "Paljonko liikevaihdosta jää jäljelle suorien kulujen (valmentaja- ym. muuttuvien kulujen) jälkeen.", en: "Revenue remaining after direct costs such as coach/session costs and other variable costs." },
  "fm.tip.net": { fi: "Bruttokate miinus kiinteät kulut ja mallinnettu vero.", en: "Gross profit minus fixed/operating costs and the modelled tax." },
  "fm.tip.netmargin": { fi: "Osuus liikevaihdosta, joka jää jäljelle mallinnettujen kulujen ja veron jälkeen.", en: "Percentage of revenue remaining after modelled operating costs and tax assumptions." },
  "fm.tip.be": { fi: "Myynti, jolla tulos on tasan nolla — kiinteät kulut on katettu.", en: "The sales level where profit is exactly zero — fixed costs are covered." },
  "fm.tip.becustomers": { fi: "Nollapisteen treenit jaettuna treeneillä per asiakas, pyöristettynä ylöspäin.", en: "Break-even sessions divided by sessions per customer, rounded up." },
  "fm.tip.fixed2": { fi: "Kulut jotka eivät riipu myynnistä: kulutaulukon kiinteät rivit + pikasäätö.", en: "Costs independent of sales: the itemized fixed rows + the quick adjustment." },
  "fm.tip.taxrow": { fi: "Yksinkertaistettu vero: oletuksena tuloksesta (vain positiivisesta), valinnaisesti liikevaihdosta.", en: "Simplified tax: on profit by default (positive only), optionally on revenue." },
  "fm.tip.contribution": { fi: "Katetuotto: mitä yksi lisätreeni tuo kiinteiden kulujen kattamiseen (hinta − treenikohtaiset kulut − %-kulut).", en: "Contribution margin: what one extra session adds toward fixed costs (price − per-session costs − %-of-revenue costs)." },
  "fm.wf.revenue": { fi: "Liikevaihto", en: "Revenue" },
  "fm.wf.variable": { fi: "Muuttuvat kulut", en: "Variable costs" },
  "fm.wf.gross": { fi: "Bruttokate", en: "Gross profit" },
  "fm.wf.fixed": { fi: "Kiinteät kulut", en: "Fixed costs" },
  "fm.wf.pretax": { fi: "Tulos ennen veroa", en: "Pre-tax profit" },
  "fm.wf.tax": { fi: "Mallinnettu vero", en: "Modelled tax" },
  "fm.wf.net": { fi: "Nettotulos", en: "Net profit" },
  "fm.wf.contribution": { fi: "Katetuotto", en: "Contribution" },
  "fm.wf.sessions": { fi: "Treenit / kk", en: "Sessions / month" },
  "fm.unit.session": { fi: "treeni", en: "session" },
  "fm.unit.month": { fi: "/kk", en: "/mo" },
  "fm.unit.customers": { fi: "asiakasta", en: "customers" },
  "fm.be.heading": { fi: "Nollapiste (break-even)", en: "Break-even" },
  "fm.be.sub": { fi: "Kuinka paljon myyntiä tarvitaan, että kiinteät kulut on katettu — sen jälkeen jokainen treeni tuottaa voittoa.", en: "How much sales is needed to cover fixed costs — beyond it every session is profit." },
  "fm.be.revenue": { fi: "Liikevaihto", en: "Revenue" },
  "fm.be.sessions": { fi: "Treenit / kk", en: "Sessions / month" },
  "fm.be.customers": { fi: "Asiakkaat", en: "Customers" },
  "fm.be.note": { fi: "Jokainen treeni tuo {contribution} kiinteiden kulujen kattamiseen.", en: "Each session contributes {contribution} toward fixed costs." },
  "fm.be.never": { fi: "ei saavutettavissa", en: "not reachable" },
  "fm.be.unreachable": { fi: "Nollapistettä ei ole: yksi treeni ei tuota katetta nykyisillä oletuksilla (hinta ≤ muuttuvat kulut per treeni). Nosta hintaa tai laske treenikohtaisia kuluja.", en: "No break-even exists: a session earns no contribution with these assumptions (price ≤ variable cost per session). Raise the price or lower per-session costs." },
  "fm.need.heading": { fi: "Montako asiakasta tarvitsen?", en: "How many customers do I need?" },
  "fm.need.sub": { fi: "Nykyisillä oletuksilla (hinta, treenit/asiakas, kulut, vero).", en: "With the current assumptions (price, sessions/customer, costs, tax)." },
  "fm.need.be": { fi: "Nollapisteeseen", en: "To break even" },
  "fm.need.revenue": { fi: "Liikevaihtotavoitteeseen", en: "For target revenue" },
  "fm.need.profit": { fi: "Tulostavoitteeseen", en: "For target profit" },
  "fm.need.margin": { fi: "Marginaalitavoitteeseen", en: "For target net margin" },
  "fm.need.th.goal": { fi: "Tavoite", en: "Goal" },
  "fm.need.th.customers": { fi: "Asiakkaita", en: "Customers" },
  "fm.need.th.sessions": { fi: "Treenejä / kk", en: "Sessions / month" },
  "fm.solve.heading": { fi: "Tavoitelaskuri — ratkaise taaksepäin", en: "Target calculator — solve backwards" },
  "fm.solve.sub": { fi: "Aseta tavoite ja valitse mikä muuttuja ratkaistaan — muut oletukset pysyvät ennallaan. Tulos on erillinen tavoiteskenaario, se ei muuta malliasi.", en: "Set a target and pick which variable to solve — every other assumption stays constant. The result is a separate target scenario; it does not change your model." },
  "fm.solve.target": { fi: "Tavoite", en: "Target" },
  "fm.solve.value": { fi: "Arvo", en: "Value" },
  "fm.solve.for": { fi: "Ratkaise", en: "Solve for" },
  "fm.solve.run": { fi: "Laske", en: "Calculate" },
  "fm.solve.t.revenue": { fi: "Liikevaihto / kk (€)", en: "Monthly revenue (€)" },
  "fm.solve.t.revenueAnnual": { fi: "Liikevaihto / v (€)", en: "Annual revenue (€)" },
  "fm.solve.t.profit": { fi: "Nettotulos / kk (€)", en: "Monthly net profit (€)" },
  "fm.solve.t.profitAnnual": { fi: "Nettotulos / v (€)", en: "Annual net profit (€)" },
  "fm.solve.t.netMargin": { fi: "Nettomarginaali (%)", en: "Net margin (%)" },
  "fm.solve.sessionsTotal": { fi: "Treenit yhteensä / kk", en: "Total sessions / month" },
  "fm.solve.answer": { fi: "Tarvitaan: {label} = {value}", en: "Required: {label} = {value}" },
  "fm.solve.col.current": { fi: "Nykyinen malli", en: "Current model" },
  "fm.solve.col.target": { fi: "Tavoiteskenaario", en: "Target scenario" },
  "fm.solve.note": { fi: "Kokonaiset asiakkaat ja treenit pyöristetään ylöspäin, hinta seuraavaan senttiin. Mallinnettu skenaario — oletuksesi eivät muuttuneet.", en: "Whole customers and sessions round up; price rounds up to the next cent. A modelled scenario — your assumptions were not changed." },
  "fm.solve.noresult": { fi: "—", en: "—" },
  "fm.solve.err.bad_target": { fi: "Anna tavoitteelle kelvollinen arvo.", en: "Give the target a valid value." },
  "fm.solve.err.bad_solve_for": { fi: "Valitse ratkaistava muuttuja.", en: "Pick a variable to solve for." },
  "fm.solve.err.needs_sessions_per_customer": { fi: "Aseta ensin treenit/asiakas suuremmaksi kuin 0.", en: "Set sessions per customer above 0 first." },
  "fm.solve.err.no_effect": { fi: "Valittu muuttuja ei vaikuta tavoitteeseen nykyisillä oletuksilla (esim. treenejä on 0).", en: "The chosen variable does not affect the target with the current assumptions (e.g. zero sessions)." },
  "fm.solve.err.unreachable": { fi: "Tavoite ei ole saavutettavissa tällä muuttujalla — muut oletukset rajoittavat (esim. kate tai rakenteellinen marginaali ei riitä).", en: "The target is not reachable with this variable — other assumptions cap it (e.g. contribution or structural margin is insufficient)." },
  "fm.cost.th.name": { fi: "Kulu", en: "Cost" },
  "fm.cost.th.kind": { fi: "Tyyppi", en: "Type" },
  "fm.cost.th.amount": { fi: "Summa", en: "Amount" },
  "fm.cost.kind.fixed": { fi: "Kiinteä / kk", en: "Fixed / operating" },
  "fm.cost.kind.per_session": { fi: "€ / treeni (muuttuva)", en: "€ / session (variable)" },
  "fm.cost.kind.pct_revenue": { fi: "% liikevaihdosta (muuttuva)", en: "% of revenue (variable)" },
  "fm.cost.notes": { fi: "Muistiinpano", en: "Notes" },
  "fm.cost.add": { fi: "Lisää kulu", en: "Add cost" },
  "fm.cost.example": { fi: "vakuutus / markkinointi…", en: "insurance / marketing…" },
  "fm.cost.deactivate": { fi: "Pois käytöstä", en: "Deactivate" },
  "fm.cost.activate": { fi: "Käyttöön", en: "Activate" },
  "fm.cost.delete": { fi: "Poista kulu", en: "Delete cost" },
  "fm.cost.delete.confirm": { fi: "Poistetaanko tämä kulurivi mallista?", en: "Remove this cost row from the model?" },
  "fm.cost.totals": { fi: "yhteensä (aktiiviset)", en: "totals (active)" },
  "fm.scen.name.ph": { fi: "Skenaarion nimi, esim. 'Hinta 45 €'", en: "Scenario name, e.g. 'Price €45'" },
  "fm.scen.name.missing": { fi: "Anna skenaariolle nimi.", en: "Give the scenario a name." },
  "fm.scen.saved": { fi: "Skenaario tallennettu.", en: "Scenario saved." },
  "fm.scen.load": { fi: "Lataa malliin", en: "Load into the model" },
  "fm.scen.load.confirm": { fi: "Korvataanko nykyiset oletukset skenaariolla \"{name}\"?", en: "Replace the current assumptions with scenario \"{name}\"?" },
  "fm.scen.compare": { fi: "Vertaa", en: "Compare" },
  "fm.scen.delete": { fi: "Poista", en: "Delete" },
  "fm.scen.none": { fi: "Ei tallennettuja skenaarioita.", en: "No saved scenarios." },
  "fm.scen.col.current": { fi: "Nykyinen malli", en: "Current model" },
  "fm.costs.heading": { fi: "Kuukausikulut", en: "Monthly costs" },
  "fm.costs.sub": { fi: "Mallin kulurivit (Render, Gandi, Brevo, vakuutus, markkinointi…). Kiinteä = sama summa joka kuukausi; per treeni ja % liikevaihdosta = muuttuvia kuluja. Nämä ovat mallinnusoletuksia — eivät kirjanpitoa.", en: "The model's cost rows (Render, Gandi, Brevo, insurance, marketing…). Fixed = the same amount every month; per session and % of revenue = variable costs. These are modelling assumptions — not accounting." },
  "fm.scen.heading": { fi: "Skenaariot", en: "Scenarios" },
  "fm.scen.sub": { fi: "Tallenna nykyiset oletukset nimellä ja vertaa skenaarioita rinnakkain. Tallennetut skenaariot ovat erillään oikeasta liiketoimintadatasta.", en: "Save the current assumptions under a name and compare scenarios side by side. Saved scenarios stay separate from actual business data." },
  "fm.scen.save": { fi: "Tallenna skenaario", en: "Save scenario" },
  ...
  "admin.sources.sub": { fi: "Kävijät, liidit, uudet asiakkaat, varaukset ja liikevaihto hankintalähteittäin. Aikaväli valitaan sivun ylälaidan painikkeista; lähde määräytyy kävijän ensimmäisestä käynnistä (utm_source-parametri tai viittaava sivusto).", en: "Visitors, leads, new customers, bookings and revenue by acquisition source. The time window follows the pills at the top of the page; the source comes from the visitor's first visit (utm_source parameter or referring site)." },
  "admin.sources.th.source": { fi: "Lähde", en: "Source" },
  "admin.sources.th.visitors": { fi: "Uudet kävijät", en: "New visitors" },
  "admin.sources.th.leads": { fi: "Liidit", en: "Leads" },
  "admin.sources.th.customers": { fi: "Uudet asiakkaat", en: "New customers" },
  "admin.sources.th.bookings": { fi: "Varaukset", en: "Bookings" },
  "admin.sources.th.revenue": { fi: "Liikevaihto", en: "Revenue" },
  "admin.sources.th.conversion": { fi: "Konversio", en: "Conversion" },
  "admin.sources.empty": { fi: "Ei vielä lähdedataa — se alkaa kertyä kävijöistä, yhteydenotoista ja rekisteröitymisistä.", en: "No source data yet — it accumulates from visitors, contact requests and signups." },
  "admin.sources.hint": { fi: "Vinkki: lisää kampanjalinkkeihin ?utm_source=facebook (tms.), niin lähde kirjautuu aina varmasti oikein.", en: "Tip: add ?utm_source=facebook (etc.) to campaign links so the source is always recorded reliably." },
  "admin.sources.src.direct": { fi: "Suora käynti", en: "Direct" },
  "admin.sources.src.unknown": { fi: "Tuntematon (ennen seurantaa)", en: "Unknown (before tracking)" },
  "admin.sources.src.admin": { fi: "Ylläpidon luoma", en: "Created by admin" },
  ...
  "admin.crm.table.lastseen": { fi: "Viimeksi paikalla", en: "Last seen" },
  ...
  // Relative "time ago" labels (admin CRM "last seen", etc.).
  "time.justnow": { fi: "juuri nyt", en: "just now" },
  "time.minsago": { fi: "{n} min sitten", en: "{n} min ago" },
  "time.hoursago": { fi: "{n} h sitten", en: "{n} h ago" },
  "time.daysago": { fi: "{n} pv sitten", en: "{n} d ago" },
  ...
  "admin.disc.heading": { fi: "Alennuskoodit", en: "Discount codes" },
  "admin.disc.sub": { fi: "Luo koodeja, jotka antavat prosentti- tai euromääräisen alennuksen. Rajaa käyttökertojen määrällä, voimassaoloajalla tai molemmilla — jätä kenttä tyhjäksi, jos rajaa ei ole. Koodit toimivat kaikilla maksullisilla tuotteilla tarjoushinnan päälle.", en: "Create codes that take a percentage or a fixed euro amount off. Limit by a number of uses, an expiry date, or both — leave a field blank for no limit. Codes work on every paid product, on top of the sale price." },
  "admin.disc.empty": { fi: "Ei vielä alennuskoodeja.", en: "No discount codes yet." },
  "admin.disc.f.code": { fi: "Koodi", en: "Code" },
  "admin.disc.f.kind": { fi: "Tyyppi", en: "Type" },
  ...
  "admin.disc.kind.fixed": { fi: "Kiinteä (€)", en: "Fixed (€)" },
  "admin.disc.create": { fi: "Luo koodi", en: "Create code" },
  ...
  "admin.disc.paused": { fi: "Pysäytetty", en: "Paused" },
  "admin.disc.pause": { fi: "Pysäytä", en: "Pause" },
  "admin.disc.resume": { fi: "Ota käyttöön", en: "Resume" },
  "admin.disc.delete": { fi: "Poista", en: "Delete" },
  "admin.disc.confirmDelete": { fi: "Poistetaanko tämä alennuskoodi? Aiemmat varaukset säilyttävät saamansa alennuksen.", en: "Delete this discount code? Past bookings keep the discount they already got." },
...
const I18N_SERVER_EXACT = {
  ...
  "Choose how the payment is handled.": "Valitse, miten maksu hoidetaan.",
  "Choose the session type.": "Valitse treenin tyyppi.",
  "An account with this email already exists — pick it from the existing customers.": "Tällä sähköpostilla on jo tili — valitse asiakas nykyisten joukosta.",
  "Only a confirmed spot can be marked paid.": "Vain vahvistettu paikka voidaan merkitä maksetuksi.",
